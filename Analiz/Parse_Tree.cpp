...
void Parse_Tree::add_product_items(std::vector<std::shared_ptr<Tree_Node>>& children, const product& prdct) {
    if (prdct == PROGRAM) {
        ...
        children.push_back(std::make_shared<Tree_Node>(Lexeme{ type_lexeme::END, "END" }));
        children.push_back(std::make_shared<Tree_Node>(Terminal{ Terminal::ID }));
    }
        ...
        children.push_back(std::make_shared<Tree_Node>(Lexeme{ type_lexeme::INTEGER, "INTEGER" }));
    }
        ...
        children.push_back(std::make_shared<Tree_Node>(Lexeme{ type_lexeme::FOR, "FOR" }));
        children.push_back(std::make_shared<Tree_Node>(Terminal{ Terminal::ID }));
        children.push_back(std::make_shared<Tree_Node>(Lexeme{ type_lexeme::EQUALS, "=" }));
        children.push_back(std::make_shared<Tree_Node>(Terminal{ Terminal::EXPR }));
        children.push_back(std::make_shared<Tree_Node>(Lexeme{ type_lexeme::TO, "TO" }));
        children.push_back(std::make_shared<Tree_Node>(Terminal{ Terminal::EXPR }));
        children.push_back(std::make_shared<Tree_Node>(Lexeme{ type_lexeme::DO, "DO" }));
    }
        ...
        children.push_back(std::make_shared<Tree_Node>(Terminal{ Terminal::REALNUMBER }));
    }
}
